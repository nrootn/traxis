...
class Ui_skeleton(object):
    ...
    def retranslateUi(self, skeleton):
        ...
        self.label_points.setText(_translate("skeleton", "Points on picture"))
        self.label_tech.setText(_translate("skeleton", "Technical buttons"))
        ...
        self.sld_zoom.setToolTip(_translate("skeleton", "<html><head/><body><p>Zoom Control</p></body></html>"))
        ...
        self.btn_drwAngle.setText(_translate("skeleton", "Draw angle ref."))
